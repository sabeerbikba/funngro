<template>
    <div class="min-h-screen bg-[#1a2634]">
        ...
        <!-- Navigation -->
        <nav class="border-b border-gray-800 sticky top-0">
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:block">
                        <div class="flex items-center space-x-8">
                            <NuxtLink to="/teen" class="text-gray-300 hover:text-white px-3 py-2">
                                Teen
                            </NuxtLink>
                            <NuxtLink to="/company" class="text-gray-300 hover:text-white px-3 py-2">
                                Company
                            </NuxtLink>
                            <NuxtLink to="/parent" class="text-gray-300 hover:text-white px-3 py-2">
                                Parent
                            </NuxtLink>
                            <!-- <div class="flex items-center space-x-2">
                                <NuxtLink to="#" class="text-gray-300 hover:text-white">
                                    <img src="/placeholder.png" alt="Android" width={24} height={24} />
                                </NuxtLink>
                                <NuxtLink to="#" class="text-gray-300 hover:text-white">
                                    <img src="/placeholder.png" alt="iOS" width={24} height={24} />
                                </NuxtLink>
                            </div> -->
                            ...
                            <div class="gap-x-4 gap-y-4 items-center flex">
                                ...
                                <a href="https://apps.apple.com/in/app/funngro/id1579361075"
                                    class="p-[0.2rem]  text-white py-2 px-4 max-w-full inline-block">
                                    <div class="w-6 h-6 text-white">
                                        <svg width=" 100%" height=" 100%"
                                            viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
